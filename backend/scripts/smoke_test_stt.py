...
def smoke_test_stt():
    ...
    wav_path = os.path.join(base_dir, "../datasets/audio/wavs/audio_001.wav")
    ...
    try:
        ...
        decoded, _ = tf.nn.ctc_greedy_decoder(
            preds_t, sequence_length=tf.cast(input_len, tf.int32), merge_repeated=True)
        ...
        if len(pred_str) > 0:
            ...
            print(
                "WARN: Model produced empty output (might be expected if audio is silence, but unlikely).")
